...
## LICENSE GRANT
1. **Open Source Use:** Free under GPL-3.0 for non-commercial use
2. **Commercial Use:** Requires compliance with terms below
3. **Enterprise Use:** Requires separate written agreement
...
1. **Code Ownership:** Licensor retains all IP rights
2. **Brand Usage:** Cannot use "PhoenixPME" trademark without permission
3. **Derivative Works:** Must remain GPL-3.0 compliant
4. **Patent Rights:** Licensor reserves all patent rights

## AUDIT RIGHTS
Licensor may audit Licensee's implementation once annually with 30 days notice to verify compliance.

## TERMINATION
Violation of terms results in immediate termination and requirement to cease using PhoenixPME code.
